...
object DraftLayout {
    ...
    val leftBanSlots = listOf(
        square(0.074f, 0.045f, 0.045f, 0.075f),
        square(0.120f, 0.045f, 0.045f, 0.075f),
        square(0.166f, 0.045f, 0.045f, 0.075f),
        square(0.212f, 0.045f, 0.045f, 0.075f),
        square(0.258f, 0.045f, 0.045f, 0.075f)
    )

    // Верхние баны справа.
    val rightBanSlots = listOf(
        square(0.742f, 0.045f, 0.045f, 0.075f),
        square(0.788f, 0.045f, 0.045f, 0.075f),
        square(0.834f, 0.045f, 0.045f, 0.075f),
        square(0.880f, 0.045f, 0.045f, 0.075f),
        square(0.926f, 0.045f, 0.045f, 0.075f)
    )
    ...
    val allyPickDetectionSlots = listOf(
        NormRect(0.066f, 0.080f, 0.125f, 0.210f),
        NormRect(0.066f, 0.245f, 0.125f, 0.375f),
        NormRect(0.066f, 0.410f, 0.125f, 0.540f),
        NormRect(0.066f, 0.575f, 0.125f, 0.705f),
        NormRect(0.066f, 0.740f, 0.125f, 0.870f)
    )
    ...
    val enemyPickDetectionSlots = listOf(
        NormRect(0.880f, 0.080f, 0.958f, 0.210f),
        NormRect(0.880f, 0.245f, 0.958f, 0.375f),
        NormRect(0.880f, 0.410f, 0.958f, 0.540f),
        NormRect(0.880f, 0.575f, 0.958f, 0.705f),
        NormRect(0.880f, 0.740f, 0.958f, 0.870f)
    )
